  ...
  packages = with beamPackages; with self; {
    ...
    lib_secp256k1 = buildMix rec {
      ...
      src = fetchHex {
        pkg = "lib_secp256k1";
        version = "${version}";
        sha256 = "c12d0b6b2a9a37bbdb1f9e4e8db0026a73cda52e66246f59ae11ff47599cbc1c";
      };
    ...
    nostr_lib = buildMix rec {
      ...
      beamDeps = [ ex_bech32 jason lib_secp256k1 ];
    };
    ...
    phoenix_live_view = buildMix rec {
      ...
      src = fetchHex {
        ...
        version = "${version}";
        sha256 = "13f833a39b1368117e0529c0fe5029930a9bf11e2fb805c2263fcc32950f07a2";
      };
